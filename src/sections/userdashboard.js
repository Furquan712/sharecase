...
import { Container, Box, Heading, Text, Button, Link, Flex } from "theme-ui";
import ModalVideo from "react-modal-video";
import { IoIosPlayCircle } from "react-icons/io";
import UserImage from "assets/Banner-1.png";
import { Card } from "theme-ui";
import Trendingcard from "sections/trendingcard";
import Searchbox from 'sections/searchbox';


const User_DATA = {
  title: "Welcome to next level of Stock Market",
  text: "Think Bigger, Earn Bigger.",
  button: {
    link: "#",
    label: "Search your Bucket here",
  },
  button1: {
    link: "#",
    label: "Load More",
  ...
  videoBtn: {
    link: "#",
    label: "Learn ShareCase",
  },
  UserImage: UserImage,
};

const User = () => {
  const { title, text, button, button1, videoBtn, UserImage } = User_DATA;
  ...
  return (
    <>
      <Box as="section" id="User" sx={styles.section}>
        ...
        <Box sx={styles.content}>
          ...
          <Box sx={styles.sectionImage}>
            <Image src={UserImage} alt="User Mockup" width={740} height={442} />
          </Box>
        </Container>    
      </Box>
  ...
  <Box>
    <Box>
        <h1 style={{textAlign:"center"}}>Trending Buckets</h1>
    <Trendingcard/>
           <Trendingcard/>
           <Trendingcard/>
           <Trendingcard/>
           <Trendingcard/>
           <Box sx={styles.btnWrap} style={{ justifyContent:"center"}}>
        <Link href={button1.link} sx={styles.btn}>
          {button1.label}
        </Link>
      </Box>     
    </Box>
